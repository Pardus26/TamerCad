import { BRepIntersector } from "./BRepIntersector";
...
export class BRepBooleanEngine {
     ...
     */
    static union(a, b) {
        const intersection = BRepIntersector
            .intersectSolids(a, b);
        /*
            Pipeline:
        ...
        */
        const merged = BRepMerge.solids(a, b);
        const healed = BRepHeal.heal(merged.result);
        return {
     ...
     */
    static subtract(a, b) {
        const result = this.difference(a, b);
        return result.solid;
    }
    /**
     * Debug
    ...
    static info() {
        return {
            engine: "BRepBooleanEngine",
            status: "READY"
        };
    }
}
//# sourceMappingURL=BRepBooleanEngine.js.map