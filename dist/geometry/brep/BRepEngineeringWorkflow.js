export class BRepEngineeringWorkflow {
    ...
    approve() {
        return {
            approved: true,
            message: "Engineering workflow approved"
        };
    }
    /**
     * Öğrenme
    ...
    info() {
        return {
            engine: "BRepEngineeringWorkflow",
            status: this.running
                ?
                    "EXECUTING"
                :
...
//# sourceMappingURL=BRepEngineeringWorkflow.js.map