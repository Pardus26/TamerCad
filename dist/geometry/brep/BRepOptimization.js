export class BRepOptimization {
    ...
    objectiveValue() {
        ...
        switch (this.objective.type) {
            ...
            case "stiffness":
                return -this.calculateStiffness();
        }
    }
    /**
     * Kütle hesabı
     */
    calculateMass() {
        return this.variables.reduce((sum, variable) => sum +
            variable.value, 0);
    }
    /**
     * Stress objective
            ...
            variable.value +=
                (Math.random()
                    ...
                    *
                        0.01;
            variable.value =
                Math.max(variable.min, Math.min(variable.max, variable.value));
        }
    }
    /**
...
//# sourceMappingURL=BRepOptimization.js.map